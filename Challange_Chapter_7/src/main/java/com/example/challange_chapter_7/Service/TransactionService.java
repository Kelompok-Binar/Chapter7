...
import com.example.challange_chapter_7.Repository.*;
import com.example.challange_chapter_7.Security.UserInfoUserDetails;
...
//    UserInfoUserDetails userDetails;
    ...
    public TransactionEntity buyTicket(TransactionEntity transaction) {
        ...
        if (transactionExist == null) {
            ...
            transactionExist.setUid_transaction(generateUUID()); // Menetapkan UUID baru
    ...
    public void truncate(){
        //TransactionEntity delete = transactionInterface.deleteAll();
