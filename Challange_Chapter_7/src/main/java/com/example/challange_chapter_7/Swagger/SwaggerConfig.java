package com.example.challange_chapter_7.Swagger;
...
public class SwaggerConfig {
    ...
    @Bean
    public OpenAPI api(@Value("Challange Chapter 7 Dokumentasi Tiket Bioskop API")String appDescription,@Value("v1.0.0") String appVersion){
